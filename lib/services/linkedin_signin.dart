...
Widget getWebView(context) {
  var url =
      "https://lmma-linkedin.auth.us-east-1.amazoncognito.com/oauth2/authorize?response_type=code&identity_provider=Auth0-LinkedIn&client_id=17dek63mv7hiqt5th6as9ivasa&redirect_uri=https://example.com/&scope=openid";
  return WebView(
    initialUrl: url,
...
//https://lmma-linkedin.auth.us-east-1.amazoncognito.com/logout?client_id=17dek63mv7hiqt5th6as9ivasa&logout_uri=https://example.com/
// za logout koristiti endpoint iznad
